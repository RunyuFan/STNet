...
from models.model_fuse import STNet, CheckinNet
...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for images, msi, checkin, labels in train_loader:
            ...
            checkin_feature, outputs2 = model2(images, msi, checkin)
        ...
        if acc_2 > best_acc_2:
            ...
            torch.save(model2, os.path.join(args.model_path, 'CheckinNet-6-2-2.pth'))
            best_acc_2 = acc_2
            best_epoch = epoch
        # if acc_3 > best_acc_3:
